...
namespace Layouts_Prj.Controllers
{
    public class tblEmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "empid,empname,gender,salary,deptid")] tblEmployee tblEmployee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "empid,empname,gender,salary,deptid")] tblEmployee tblEmployee)
        {
            if (ModelState.IsValid)
            {
